...
export default function Page2(){
    ...
    return <div id="ani-text" >
                ...
                <div>
                    <h1 className=" anim-text text-[40vw] text-center uppercase leading-[33vw] font-[anzo1]">Works</h1>
                </div>
                
                <div className="flex justify-center mt-10 items-center">
                <svg className="scale-75"  preserveAspectRatio="xMidYMid meet" data-bbox="4 0 2028.339 83" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2037 91" height="91" width="2037" data-type="ugc" role="img" aria-label="Tesla, Figma, Wix Studio, Google+, BeHance monochrome Logo Design by Anzo Studio ">
    <g>
